...
Copyright (C) 2009-2013, Benjamin 'BeRo' Rosseaux
...
*******************************************************************************)
unit BESENInt64SelfBalancedTree;
{$i BESEN.inc}
...
type PBESENInt64SelfBalancedTreeValue=^TBESENInt64SelfBalancedTreeValue;
     TBESENInt64SelfBalancedTreeValue=record
      case boolean of
       false:(i:int64);
       true:(p:pointer);
     end;

     PBESENInt64SelfBalancedTreeNode=^TBESENInt64SelfBalancedTreeNode;
     TBESENInt64SelfBalancedTreeNode=record
      Parent,Left,Right,PreviousKey,NextKey:PBESENInt64SelfBalancedTreeNode;
      Level:int64;
      Key:int64;
      Value:TBESENInt64SelfBalancedTreeValue;
     end;

     TBESENInt64SelfBalancedTreeKeys=array of int64;

     TBESENInt64SelfBalancedTree=class
      protected
       procedure Skew(OldParent:PBESENInt64SelfBalancedTreeNode);
       function Split(OldParent:PBESENInt64SelfBalancedTreeNode):boolean;
       procedure RebalanceAfterLeafAdd(n:PBESENInt64SelfBalancedTreeNode);
       procedure DeleteNode(n:PBESENInt64SelfBalancedTreeNode);
       function First(StartNode:PBESENInt64SelfBalancedTreeNode):PBESENInt64SelfBalancedTreeNode;
       function Next(n:PBESENInt64SelfBalancedTreeNode):PBESENInt64SelfBalancedTreeNode;
       function FindNode(const Key:int64):PBESENInt64SelfBalancedTreeNode;
       procedure ClearNode(var Node:PBESENInt64SelfBalancedTreeNode);
       procedure OptimizeNode(var Node:PBESENInt64SelfBalancedTreeNode;MoreOptimize:boolean);
       function GetValue(Key:int64):TBESENInt64SelfBalancedTreeValue;
       procedure SetValue(Key:int64;Value:TBESENInt64SelfBalancedTreeValue);
      public
       RootNode:PBESENInt64SelfBalancedTreeNode;
       FirstKey,LastKey:PBESENInt64SelfBalancedTreeNode;
       constructor Create;
       destructor Destroy; override;
       function Find(const Key:int64;var Value:TBESENInt64SelfBalancedTreeValue):boolean;
       function Insert(const Key:int64;Value:TBESENInt64SelfBalancedTreeValue):PBESENInt64SelfBalancedTreeNode;
       procedure Remove(const Key:int64);
       procedure Optimize;
       function Keys:TBESENInt64SelfBalancedTreeKeys;
       property Values[Key:int64]:TBESENInt64SelfBalancedTreeValue read GetValue write SetValue; default;
     end;

implementation

constructor TBESENInt64SelfBalancedTree.Create;
begin
 inherited Create;
 New(RootNode);
 FillChar(RootNode^,SizeOf(TBESENInt64SelfBalancedTreeNode),#0);
 RootNode^.Level:=$7fffffffffffffff;
 FirstKey:=nil;
 LastKey:=nil;
end;

destructor TBESENInt64SelfBalancedTree.Destroy;
begin
...
function TBESENInt64SelfBalancedTree.First(StartNode:PBESENInt64SelfBalancedTreeNode):PBESENInt64SelfBalancedTreeNode;
begin
 try
...
function TBESENInt64SelfBalancedTree.Next(n:PBESENInt64SelfBalancedTreeNode):PBESENInt64SelfBalancedTreeNode;
begin
 try
...
procedure TBESENInt64SelfBalancedTree.Skew(OldParent:PBESENInt64SelfBalancedTreeNode);
var NewParent:PBESENInt64SelfBalancedTreeNode;
begin
{$ifdef UseAssert}
...
function TBESENInt64SelfBalancedTree.Split(OldParent:PBESENInt64SelfBalancedTreeNode):boolean;
var NewParent:PBESENInt64SelfBalancedTreeNode;
begin
{$ifdef UseAssert}
 Assert(assigned(OldParent));
...
procedure TBESENInt64SelfBalancedTree.RebalanceAfterLeafAdd(n:PBESENInt64SelfBalancedTreeNode);
begin
...
function TBESENInt64SelfBalancedTree.FindNode(const Key:int64):PBESENInt64SelfBalancedTreeNode;
var n:PBESENInt64SelfBalancedTreeNode;
begin
 try
  result:=nil;
  n:=RootNode^.Left;
  while assigned(n) do begin
   if Key=n^.Key then begin
    result:=n;
    break;
   end else if Key<n^.Key then begin
    n:=n^.Left;
   end else begin
    n:=n^.Right;
   end;
...
function TBESENInt64SelfBalancedTree.Insert(const Key:int64;Value:TBESENInt64SelfBalancedTreeValue):PBESENInt64SelfBalancedTreeNode;
var n,s:PBESENInt64SelfBalancedTreeNode;
    LessThan:boolean;
begin
 result:=nil;
 try
  ...
  while assigned(s) do begin
   if Key=s^.Key then begin
    n:=s;
    break;
   end else if Key<s^.Key then begin
    s:=s^.Left;
   end else begin
    s:=s^.Right;
   end;
  ...
  if assigned(s) then begin
   ...
   new(n);
   fillchar(n^,sizeof(TBESENInt64SelfBalancedTreeNode),#0);
   n^.Key:=Key;
   n^.Value:=Value;
...
procedure TBESENInt64SelfBalancedTree.DeleteNode(n:PBESENInt64SelfBalancedTreeNode);
var Leaf,Temp:PBESENInt64SelfBalancedTreeNode;
begin
 try
...
procedure TBESENInt64SelfBalancedTree.Remove(const Key:int64);
var n:PBESENInt64SelfBalancedTreeNode;
begin
 try
  n:=RootNode^.Left;
...
procedure TBESENInt64SelfBalancedTree.ClearNode(var Node:PBESENInt64SelfBalancedTreeNode);
begin
...
procedure TBESENInt64SelfBalancedTree.OptimizeNode(var Node:PBESENInt64SelfBalancedTreeNode;MoreOptimize:boolean);
var Nodes:array of TBESENInt64SelfBalancedTreeNode;
    NodeCount,NodeIndex:integer;
 procedure CountNodes(Node:PBESENInt64SelfBalancedTreeNode);
 begin
  if not assigned(Node) then begin
   exit;
  end;
 ...
 procedure CollectNodes(Node:PBESENInt64SelfBalancedTreeNode);
 begin
  if not assigned(Node) then begin
   exit;
  end;
 ...
 procedure FreeNodes(var Node:PBESENInt64SelfBalancedTreeNode);
 begin
  if not assigned(Node) then begin
   exit;
  end;
 ...
 procedure DoInsertNode(const Node:TBESENInt64SelfBalancedTreeNode);
 var n,s:PBESENInt64SelfBalancedTreeNode;
     LessThan:boolean;
 begin
  new(n);
 ...
 procedure RepairNodes(var Node:PBESENInt64SelfBalancedTreeNode);
 begin
  if not assigned(Node) then begin
   exit;
  end;
...
function TBESENInt64SelfBalancedTree.Find(const Key:int64;var Value:TBESENInt64SelfBalancedTreeValue):boolean;
var n:PBESENInt64SelfBalancedTreeNode;
begin
 n:=FindNode(Key);
 if assigned(n) then begin
  ...
  fillchar(Value,sizeof(TBESENInt64SelfBalancedTreeValue),#0);
  result:=false;
 end;
end;

procedure TBESENInt64SelfBalancedTree.Optimize;
begin
 OptimizeNode(RootNode^.Left,true);
end;

function TBESENInt64SelfBalancedTree.Keys:TBESENInt64SelfBalancedTreeKeys;
var CurrentNode:PBESENInt64SelfBalancedTreeNode;
    Count:integer;
begin
...
function TBESENInt64SelfBalancedTree.GetValue(Key:int64):TBESENInt64SelfBalancedTreeValue;
begin
 Find(Key,result);
end;

procedure TBESENInt64SelfBalancedTree.SetValue(Key:int64;Value:TBESENInt64SelfBalancedTreeValue);
begin
 Insert(Key,Value);
end;
