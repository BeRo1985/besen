 ...
 *
 * Speed-optimized for BESEN by Benjamin 'BeRo' Rosseaux
 */
...
trace(MD5("Hallo Welt!"));
trace(MD5("Hello world!"));
trace(MD5("Hallo Benutzer!"));
trace(MD5("Hello user!"));